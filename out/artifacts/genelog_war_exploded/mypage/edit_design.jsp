        ...
        <form action="edit_write.jsp">
          ...
          <div class="main col-10 offset-1">
            ...
            <div class="select_design">
                <label><input type="radio" name="design" value="" required><img class="offset-2 col-8" src="../images/white.jpg"></label>
                <label><input type="radio" name="design" value="black"><img class="offset-2 col-8" src="../images/black.jpg"></label>
                <label><input type="radio" name="design" value="blue"><img class="offset-2 col-8" src="../images/blue.jpg"></label>
                <label><input type="radio" name="design" value="pink"><img class="offset-2 col-8" src="../images/pink.jpg"></label>
                <label><input type="radio" name="design" value="green"><img class="offset-2 col-8" src="../images/green.jpg"></label>
            </div>
