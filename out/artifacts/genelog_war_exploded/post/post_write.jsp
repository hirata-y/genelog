  ...
  <body>
    <div class="container-fluid bg-slider">
      ...
      <div class="offset-2 my-4">
        <form name="test" action="post_confirm.jsp">
            ...
            <div class="main <%=designStr%> col-10 offset-1">
                  ...
                  <div class="row my-4">
                      ...
                      <textarea class="col-5 mx-2" name="text" maxlength="400" placeholder="本文"></textarea>
                  </div>
                  ...
                  <div class="col-8 mb-4">
                      <input type="text" class="form-control" name="term" placeholder="ex)30分～1時間程度" required>
                  </div>
                  ...
                  <div class="col-8 mb-4">
                      <input type="text" class="form-control" name="address" placeholder="ex)愛知県名古屋市中村区" required>
                  </div>
